...
func Compile(celExpr string, sig []v1alpha1.KProbeArg, labelPrefix string) (asm.Instructions, []uint32, error) {
...
func CompileFn(fnName, celExpr string, sig []v1alpha1.KProbeArg) (asm.Instructions, []uint32, error) {
