...
`spec.podSelector`, and `spec.containerSelector`. More details for each of them
can be found in [Host workload filters](https://tetragon.io/docs/concepts/tracing-policy/k8s-filtering/#host-workload-filters),
[Pod label filters](https://tetragon.io/docs/concepts/tracing-policy/k8s-filtering/#pod-label-filters),
and [Container field filters](https://tetragon.io/docs/concepts/tracing-policy/k8s-filtering/#container-field-filters).
